...
import com.example.demo.constant.DeviceStatusCode;
...
public class AopConfig {
    ...
    @Around("pointcut() && (@within(com.example.demo.targer.checkToken) || @annotation(com.example.demo.targer.checkToken))")
    ...
    @Before("@within(com.example.demo.targer.checkToken) || @annotation(com.example.demo.targer.checkToken)")
    ...
    @After("@within(com.example.demo.targer.checkToken) || @annotation(com.example.demo.targer.checkToken)")
    public void doAfter() {
        // TODO
        Long after = System.currentTimeMillis();
